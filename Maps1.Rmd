...
tmap_leaflet(tm_shape(muni, is.master = TRUE) +
               ...
               tm_bubbles(col = "red", size = 0.25, border.col = "black") +
               tm_shape(c) +
               tm_bubbles(col = "blue", size = 0.25, border.col = "black")+
               tm_layout(legend.position = c("RIGHT", "TOP")))
